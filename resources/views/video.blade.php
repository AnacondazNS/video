        ...
        <div class="max-w-9xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 w-full text-gray-900 dark:text-gray-100 flex justify-center">
                        ...
                        <source src="{{'storage/app/public/videos/' . $video->path}}" type="video/mp4">
                        </video>
                </div>
                    <div class="p-6 text-gray-900 dark:text-gray-100 h-auto">
                        <div class=" whitespace-nowrap flex justify-between w-max gap-5">
                            <a href="{{ route('LikeVideo', ['id' => $video->id, 'status' => 'like']) }}"
                                class="p-2 hover:bg-zinc-300 rounded w-100 bg-gray-200 dark:text-black"><button class="like"></button>
                                {{ count($like) }}</a>

                            <a href="{{ route('LikeVideo', ['id' => $video->id, 'status' => 'dislike']) }}"
                                class="p-2 hover:bg-zinc-300 rounded w-100 bg-gray-200 dark:text-black"><button class="dizlike"></button>
                                {{ count($dislike) }}</a>
                        </div>
             
                        
                        <h1 class="pb-6 font-semibold text-1xl">Описание</h1>
                        <h1 class="pb-3 font-large text-0.5xl">{{ $video->description }}</h1>
                            ...
                            <section class="py-8 lg:py-16 w-screen">
                                <div class="mx-auto">
                                    ...
                                    @foreach ($comments as $comment)
                                        <article class="comment p-6 mb-5 text-base bg-gray-200 rounded-lg dark:bg-gray-900">
